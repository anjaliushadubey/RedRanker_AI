...
# Offline company founding/reference years for companies observed in candidates.jsonl.
# This is used only for impossible timeline honeypot checks; unknown companies are
# skipped. Fictional/synthetic companies use conservative reference years so we
# avoid false positives while still catching impossible long-tenure claims.
